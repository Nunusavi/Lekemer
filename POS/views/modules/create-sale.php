                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="newTaxSale" id="newTaxSale" value="15" placeholder="15" min="0" required>
...
$(document).ready(function() {
    ...
    // Handle addProductSale button click event
    $(".salesTable").on("click", ".addProductSale", function() {
