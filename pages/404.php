...
<body class="light">
        ...
        <div class="menu-block-wrapper">
          ...
          <nav class="menu-block" id="append-menu-header">
            ...
            <ul class="site-menu-main">
              ...
              <li class="nav-item">
                <a href="/Lekmer/pricing" class="nav-link-item">Pricing</a>
              </li>
            </ul>
          </nav>
        </div>
  ...
  <div class="Le-Kemer-section-padding4">
    <div class="container">
      <div class="Le-Kemer-error-content">
        <img src="assets/images/contact/404.png" alt="">
        <h2>Oops! Looks like you took a wrong turn</h2>
      </div>
      <div class="Le-Kemer-404-bottom-btn extra-mt">
        <a class="Le-Kemer-default-btn pill" data-text="Back To Home" href="/Lekemer">
          <span class="button-wraper">Back To Home</span>
        </a>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-xl-4 col-md-12">
            <div class="Le-Kemer-footer-wrap mr-25">
              <a href="/Lekemer"><img src="assets/images/logo/logo-dark.svg" alt=""></a>
