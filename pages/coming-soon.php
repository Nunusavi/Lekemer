...
<body class="light">
  ...
  <!-- End breadcrumb-->
  <section class="Le-Kemer-section-padding4">
    <div class="container">
      <div class="Le-Kemer-countdown-wrap">
        <div class="Le-Kemer-countdown-item wow fadeInUpX" data-wow-delay="0.1s">
          <div class="countdown-days">
            <div class="number"></div>
          </div>
          <p>Days</p>
        </div>
        <div class="Le-Kemer-countdown-item wow fadeInUpX" data-wow-delay="0.2s">
          <div class="countdown-hours">
            <div class="number"></div>
          </div>
          <p>Hours</p>
        </div>
        <div class="Le-Kemer-countdown-item wow fadeInUpX" data-wow-delay="0.3s">
          <div class="countdown-minutes">
            <div class="number"></div>
          </div>
          <p>Minutes</p>
        </div>
        <div class="Le-Kemer-countdown-item wow fadeInUpX" data-wow-delay="0.4s">
      ...
      <div class="Le-Kemer-countdown-content Le-Kemer-section-title center max-width-large">
        <h2>Something great is coming soon!</h2>
      </div>
      <div class="Le-Kemer-subscription-field extra-mt blog-details-subscribe-btn">
        <input type="email" placeholder="Enter your email ">
        <button id="Le-Kemer-subscription-btn" data-text="Start a 14 days free trail" type="submit">Get
          Notified</button>
      </div>
      <div class="Le-Kemer-countdown-bottom-text">
